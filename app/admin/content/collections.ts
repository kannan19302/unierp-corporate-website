...
export const CONTENT_COLLECTIONS: ContentCollectionMeta[] = [
  ...
  { id: 'blog', label: 'Blog & Articles', icon: FileText, kind: 'list' },
  { id: 'jobs', label: 'Careers & Job Postings', icon: Briefcase, kind: 'list' },
  { id: 'events', label: 'Events & Keynotes', icon: Calendar, kind: 'list' },
  { id: 'docs', label: 'Documentation & Learning', icon: BookOpen, kind: 'list' },
